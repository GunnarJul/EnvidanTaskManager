...
namespace EnviTaskManagerFunctions
{
    ...
    {
        [FunctionName(nameof(StartTimeTriggeredDanvandTasks))]
        public async Task StartTimeTriggeredDanvandTasks(
                          ...
                          ILogger log)
        {
            var orchestratorInstanceId = ((int)TaskTypeEnum.Danvand).ToString(); ; 
            ...
            var curstomerIds = _service.GetTimeScheduleredCustomers(TaskTypeEnum.Danvand);
